(function() {
	...
	window.JCNewsDetailObjects.prototype = {
		...
		showWorkingHoursToday: function() {
			...
			if(!!itemHours) {
				itemHours.innerHTML = '<i class="fa fa-spinner fa-pulse"></i>' + BX.message('OBJECTS_ITEM_DETAIL_LOADING');
		...
		showContactsWidthForm: function() {
			if(!!this.sPanel) {
				this.adjustContacts();
					...
					BX.delegate(function(result) {
						...
						this.sPanel.appendChild(
							BX.create('DIV', {
								...
								html: !!this.sPanelContent ? this.sPanelContent + result : result
							})
						);
		...
		showContacts: function(e) {
			...
			if(!!this.sPanel && !!this.sPanelContent) {
				this.sPanel.appendChild(
					BX.create('DIV', {
						props: {
							className: 'slide-panel__title-wrap'
