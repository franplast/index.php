...
while($arIblock = $rsIblock->Fetch()) {
    $rsElements = CIBlockElement::GetList(array(), array("ACTIVE" => "Y", "IBLOCK_ID" => $arIblock["ID"]/*$arParams["CATALOG_IBLOCK_ID"]*/, "SECTION_GLOBAL_ACTIVE" => "Y", "PROPERTY_BRAND" => $arResult["ID"]), false, false, array("ID", "IBLOCK_ID", "IBLOCK_SECTION_ID"));
    while ($arElement = $rsElements->GetNext()) {
