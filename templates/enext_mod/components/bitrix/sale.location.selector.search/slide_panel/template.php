...
if(!empty($arResult["ERRORS"]["FATAL"])) {
	...
	<div id="sls-<?=$arResult['RANDOM_TAG']?>" class="bx-sls">
		<div class="bx-ui-sls-input-title"><?=Loc::getMessage("SALE_SLS_INPUT_TITLE")?></div>
		<div class="dropdown-block bx-ui-sls-input-block">
			...
			<div class="bx-ui-sls-clear" title="<?=Loc::getMessage('SALE_SLS_CLEAR_SELECTION')?>"><i class="icon-close"></i></div>
