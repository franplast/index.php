...
<html lang="<?=LANGUAGE_ID?>">
	<head>
		...
		$APPLICATION->SetAdditionalCSS($scheme."://maxcdn.bootstrapcdn.com/font-awesome/4.7.0/css/font-awesome.min.css");
		$APPLICATION->SetAdditionalCSS($scheme."://d1azc1qln24ryf.cloudfront.net/130672/ELASTOFONT/style-cf.css");
		$APPLICATION->SetAdditionalCSS($scheme."://d1azc1qln24ryf.cloudfront.net/130672/UINEXT2020/style-cf.css");		
	...
	<body class="<?=$APPLICATION->ShowProperty('catalogMenu')?>"<?=$APPLICATION->ShowProperty("backgroundColor");?>>
		...
		$isWideScreenCatalog = $arSettings["WIDESCREEN_CATALOG"]["VALUE"] == "Y" && CSite::InDir(SITE_DIR."catalog/") ? true : false;?>
					...
					<div class="top-panel__cols">
						<div class="top-panel__col top-panel__thead">								
							<div class="top-panel__cols">								
								<?//MENU_ICON//
								if(!$isSiteClosed) {?>
									<div class="top-panel__col top-panel__menu-icon-container<?=($arSettings['CATALOG_MENU']['VALUE'] == 'OPTION-3' || $arSettings['CATALOG_MENU']['VALUE'] == 'OPTION-4' || $arSettings['CATALOG_MENU']['VALUE'] == 'OPTION-5' ? ' hidden-md hidden-lg' : '')?>" data-entity="menu-icon"><i class="icon-menu"></i></div>
								<?}
								//LOGO//?>								
